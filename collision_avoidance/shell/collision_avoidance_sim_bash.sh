...
# Pane 2: ros_predict.launch
tmux split-window -v -t ros_session:0.1
tmux send-keys -t ros_session:0.2 'sleep 5; source ~/endurance_ws/devel/setup.bash; roslaunch template gazebo_sim.launch' C-m
...
# Pane 0: trajectory
tmux send-keys -t ros_session:1 'sleep 5; source ~/endurance_ws/devel/setup.bash; roslaunch mission trajectory.launch' C-m
...
tmux split-window -v -t ros_session:2
tmux send-keys -t ros_session:2.1 'sleep 7; source ~/yzk_ws/devel/setup.bash; roslaunch collision_avoidance collision_avoidance.launch' C-m
